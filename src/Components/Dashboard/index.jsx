...
const Dashboard = () => {
    ...
    const FilterComponentThree = ({ filterText, onFilter, onClear }) => (
        <>

            <select
                className="custom-select"
                aria-label="Filter Mentors By Position"
                onChange={onFilter} value={filterText}>
    ...
    const subHeaderComponentMemoThree = React.useMemo(() => {
        const handleClear = () => {
            if (filterText) {
                setResetPaginationToggle(!resetPaginationToggle);
                setFilterText('');
        ...
        return (
            <FilterComponentThree onFilter={e => setFilterText(e.target.value)} onClear={handleClear} filterText={filterText} />
    ...
    return (
        ...
        <DataTable
            ...
            subHeader
            subHeaderComponent={[subHeaderComponentMemo, subHeaderComponentMemoTwo, subHeaderComponentMemoThree]}
            selectableRows
            persistTableHead
        />
    );
